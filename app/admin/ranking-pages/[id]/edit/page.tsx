...
export default function EditRankingPagePage({
  params,
}: {
  params: { id: string };
}) {
  ...
  useEffect(() => {
    const fetchPage = async () => {
      try {
        const response = await fetch(`/api/admin/ranking-pages/${params.id}`);
        ...
        if (data.success) {
          ...
          setFormData({
            ...
            cityId: page.cityId || "",
            subAreaId: page.subAreaId || "",
            categoryId: page.categoryId || "",
            subCategoryId: page.subCategoryId || "",
            limit: page.limit || 10,
            sortBy: page.sortBy || "rating",

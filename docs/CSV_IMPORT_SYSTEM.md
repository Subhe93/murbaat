# 📋 نظام استيراد الشركات من ملف CSV
...
```csv
Keyword,Nom,Note,Catégorie,Adresse,Téléphone,SiteWeb,PlusCode,Images,Photos,HeroImage,StreetView,Reviews,ReviewCount,BusinessHours,PriceLevel,Amenities
```
...
### 3. معالجة المواقع
```typescript
// استخراج المدينة والبلد من العنوان
...
### مثال على ملف CSV:
```csv
Keyword,Nom,Note,Catégorie,Adresse,Téléphone,SiteWeb,Images
"شركة برمجة دمشق","شركة التقنية المتقدمة","4.5 (12)","Software company","Damascus, Syria","+963 11 1234567","https://example.com","https://image1.jpg;https://image2.jpg"
```

...
import { Search, Filter, X, Star, MapPin, Tag, Shield, SlidersHorizontal } from 'lucide-react'
...
export function CountryFilters({ filterOptions, currentFilters, countryCode }: CountryFiltersProps) {
  ...
  useEffect(() => {
    ...
    if (currentFilters.cityId) count++
    if (currentFilters.minRating) count++
    if (currentFilters.isVerified !== undefined) count++
